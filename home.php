...
<html>
<head>
  <title>Lampung Trip</title>
  <link rel="stylesheet" type="text/css" href="plugin/bootstrap/css/bootstrap.min.css">
  <link rel="stylesheet" type="text/css" href="asset/css/main.css">
  <link rel="icon" type="image/gif/png" href="asset/gambar/Brand1.jpeg">
</head>
<body>
...
<div class="container-fluid" id="isi" >
  ...
  <div class="row">
    <div class="col-xs-2 col-xs-offset-5" id="produk-laris">
      <h3 style="font-family: Blacksword; font-size:2.2em;"><strong>Tujuan Wisata</strong></h3>
    </div>
  </div>
  ...
  <div class="container" id="produk">
            ...
            <li>
              ...
              if(isset($_SESSION['idUser'])){
                if($arrayPria['stock'] > 0){
                  echo '
                  <a href="proses/beli.php?idProduk='.$arrayPria['idProduk'].'&idUser='.$iduser.'"><button type="button" class="btn btn-info">Pilih Destinasi</button></a>
                ';
                }else{
                  echo '
                  <button type="button" class="btn btn-info disabled">Pilih Destinasi</button>
                ';
                }
              }else{
                echo '
    ...
    <div class="container-fluid" id="paging">
      ...
      if($left_rec < $limit){
          $last = $page - 2;
          echo "<a href = \"?page=$last\"><button type='button' class='btn btn-primary left'>Sebelumnya</button></a>";
        }else if($page > 0){
          $last = $page - 2;
          echo "<a href = \"?page=$last\"><button type='button' class='btn btn-primary left'>Sebelumnya</button></a>";
          echo "<a href = \"?page=$page\"><button type='button' class='btn btn-primary right'>Selanjutnya</button></a>";
        }else if( $page == 0 ) {
          echo "<a href = \"?page=$page\"><button type='button' class='btn btn-primary right'>Selanjutnya</button></a>";
        }
       ?>
