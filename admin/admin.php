  ...
  <div class="row">
    <div class="col-xs-2" id="sideLeft">
      ...
      <ul class="nav nav-pills nav-stacked" id="data">
        ...
        <li><a data-toggle="tab" href="#barang">Wisata</a></li>
    ...
    <div class="col-xs-10">
      <div class="tab-content">
        ...
        <div id="barang" class="tab-pane fade">
          <h3 class="table-title"><strong>Tabel Destinasi Wisata</strong></h3>
          <button type="button" class="btn btn-success" id="tambah-data-barang" data-toggle="modal" data-target="#form-barang">Tambah Destinasi</button>
                  ...
                  <div class="modal-body">
                      ...
                      <div class="form-group">
                        ...
                        <select class="form-control" id="kategori" name="kategori">
                          <option value="pria">Pantai</option>
                          <option value="wanita">Danau</option>
                          <option value="anak">Pulau</option>
                          <option value="couple">Taman Nasional</option>
                          <option value="sarimbit">Bukit</option>
                        </select>
                      </div>
                      <div class="form-group">
                        <label for="ukuran">Golongan</label>
          ...
          <div class="container">
            ...
            <ul class="nav nav-pills" style="margin-left: 15vw;">
              <li class="dropdown active item-kategori">
                <a class="dropdown-toggle" data-toggle="dropdown" href="#">Bahari<span class="caret"></span></a>
                <ul class="dropdown-menu">
                  <li><a data-toggle="tab" href="#tabel-pria">Pantai</a></li>
                  <li><a data-toggle="tab" href="#tabel-wanita">Danau</a></li>                     
                </ul>
              </li>
              <li class="item-kategori"><a data-toggle="tab" href="#tabel-anak">Pulau</a></li>
              <li class="item-kategori"><a data-toggle="tab" href="#tabel-couple">Taman Nasional</a></li>              
              <li class="item-kategori"><a data-toggle="tab" href="#tabel-sarimbit">Bukit</a></li>
            </ul>
          </div>
                    ...
                    <table class="table table-condensed" style="width:80vw">
                      <thead>
                        <tr>
                          ...
                          <th class="nama-barang text-center">Nama Destinasi</th>
                          <th class="keterangan-barang text-center">Keterangan</th>
                          <th class="harga-barang text-center">Harga Tiket</th>
                          <th class="ukuran-barang text-center">Golongan</th>
                          <th class="stock-barang text-center">Stock Tiket</th>
                          <th class="gambar">Gambar Wisata</th>
                          <th class="hapus"></th>
                        </tr>
                      </thead>
                      <tbody>
                    ...
                    <table class="table table-condensed" style="width:80vw">
                      <thead>
                        <tr>
                          ...
                          <th class="ukuran-barang text-center">Golongan</th>
                          <th class="stock-barang text-center">Stock Tiket</th>
                          <th class="gambar">Gambar Destinasi</th>
                          <th class="hapus"></th>
                        </tr>
                      </thead>
                      <tbody>
                ...
                <table class="table table-hover">
                  <thead>
                    <tr>
                      ...
                      <th class="text-center" style="width:30vw">Nama Destinasi</th>
