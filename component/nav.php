  ...
  $conn = mysqli_connect('localhost', 'zuhrufun', '#DatabasedUSY1', 'toko2_db');
    ...
    <form action="pencarian.php" method="get" class="navbar-form navbar-right" style="margin-top: 4vh">
      <div class="input-group" style="width:45vw; margin-right: 8vw; margin-top: 1vh;">
        <input type="text" class="form-control" placeholder="Temukan Destinasi" name="keyword">
...
<div class="container-fluid kategori">
  <div class="row">
    <div class="col-xs-2 col-xs-offset-2">
        <a href="home.php"><img style="width:14vw; height:7vh; padding-top:2vh;" alt="Brand" src="asset/gambar/Brand1.png"></a>
    </div>
    <div class="col-xs-6">
      <ul class="nav nav-pills kategori2">
        <li class="dropdown active"><a href="#" class="dropdown-toggle" data-toggle="dropdown">Bahari<span class="caret" style="margin-left:10px"></span></a>
            <ul class="dropdown-menu">
              <li><a data-toggle="pill" href="#pria">Pantai</a></li>
              <li><a data-toggle="pill" href="#wanita">Danau</a></li>
            </ul>

        </li>
        <li><a data-toggle="pill" href="#couple">Taman Nasional</a></li>
        <li><a data-toggle="pill" href="#anak" >Pulau</a></li>
        <li><a data-toggle="pill" href="#sarimbit">Bukit</a></li>
      </ul>
    </div>
  </div>
</div>
